...
class EntryReviewOpponentAcceptedToUserNotification extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            ...
            'link'          => $link,
            'matter'        => '你在词条《'.$entry->title.'》的评审计划<'.$entryReview->title.'>中提出的反对意见<'.$this->entryReviewOpponent->title.'>已被接受。'
        ];
    }
