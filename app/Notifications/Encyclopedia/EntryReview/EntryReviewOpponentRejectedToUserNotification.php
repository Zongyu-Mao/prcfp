...
class EntryReviewOpponentRejectedToUserNotification extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            ...
            'link'          => $link,
            'matter'        => '你在词条《'.$entry->title.'》评审计划<'.$entryReview->title.'>中的反对意见<'.$parentOpponent->title.'>已被拒绝，理由：<'.$this->entryReviewOpponent->title.'>。'
        ];
    }
