...
class EntryReviewAdvisementRejectedNotification extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            ...
            'link'          => $link,
            'matter'        => '协作词条《'.$entry->title.'》的评审计划<'.$entryReview->title.'>中的建议<'.$parentAdvise->title.'>已被拒绝，理由：<'.$this->entryReviewAdvise->title.'>。'
        ];
    }
