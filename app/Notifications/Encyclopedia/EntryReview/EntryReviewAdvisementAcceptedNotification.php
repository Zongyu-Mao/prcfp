...
class EntryReviewAdvisementAcceptedNotification extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            'creator_id'    => $this->entryReviewAdvise->recipient_id,
            'creator'       => $this->entryReviewAdvise->recipient,
            'link'          => $link,
            'matter'        => '你在词条《'.$entry->title.'》的评审计划<'.$entryReview->title.'>中提出的建议<'.$this->entryReviewAdvise->title.'>已被接受。'
        ];
    }
