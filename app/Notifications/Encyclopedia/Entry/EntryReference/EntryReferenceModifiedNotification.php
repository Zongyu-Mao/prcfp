...
class EntryReferenceModifiedNotification extends Notification
{
    use Queueable;
     ...
     public function toDatabase($notifiable)
    {
        ...
        $doer = User::find($this->entryReference->revisor);
        return [
            'creator_id'    => $doer->id,
            'creator'       => $doer->username,
            'link'          => $link,
            'matter'        => '你关注的词条《'.$entry->title.'》的参考文献['.$this->entryReference->sort.']已经修改。'
        ];
    }
