...
class EntryDebateBCSCreatedToRefereeNotification extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            ...
            'link'          => $link,
            'matter'        => '['.$this->entryDebate->Bauthor.']已经在你裁判的攻辩：<'.$this->entryDebate->title.'>发表辩方的总结陈词。现在你可以在'.$this->entryDebate->deadline.'之前对该攻辩进行裁判总结并结算攻辩。[来自词条：《'.$entry->title.'》]。'
        ];
    }
