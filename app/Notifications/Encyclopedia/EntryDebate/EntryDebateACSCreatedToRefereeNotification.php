...
class EntryDebateACSCreatedToRefereeNotification extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            ...
            'link'          => $link,
            'matter'        => '['.$this->entryDebate->Aauthor.']已经在你裁判的攻辩：<'.$this->entryDebate->title.'>发表攻方的总结陈词。[归口词条：《'.$entry->title.'》]。'
        ];
    }
