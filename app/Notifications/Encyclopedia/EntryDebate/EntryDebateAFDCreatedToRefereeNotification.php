...
class EntryDebateAFDCreatedToRefereeNotification extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            ...
            'link'          => $link,
            'matter'        => '['.$this->entryDebate->Aauthor.']已经在你裁判的攻辩：<'.$this->entryDebate->title.'>发表攻方的自由辩论。[来自词条：《'.$entry->title.'》]。'
        ];
    }
