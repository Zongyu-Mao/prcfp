...
class EntryDebateBOpeningCreatedToRefereeNotification extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            ...
            'link'          => $link,
            'matter'        => '['.$this->entryDebate->Bauthor.']已经在你裁判的攻辩：<'.$this->entryDebate->title.'>发表辩方的开篇陈词。[来自词条：《'.$entry->title.'》]。'
        ];
    }
