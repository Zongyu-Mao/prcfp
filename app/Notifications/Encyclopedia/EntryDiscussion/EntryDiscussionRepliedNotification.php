...
class EntryDiscussionRepliedNotification extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        $parentDiscussion = EntryDiscussion::find($this->entryDiscussion->pid);
        ...
        return [
            ...
            'link'          => $link,
            'matter'        => '你在词条《'.$entry->title.'》的[普通]讨论内容<'.$parentDiscussion->title.'>已被回复，内容：<'.$this->entryDiscussion->title.'>。'
        ];
    }
