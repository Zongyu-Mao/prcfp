...
class EntryCooperationMessageRepliedNotification extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        $parentMessage = EntryCooperationMessage::find($this->entryCooperationMessage->pid);
        ...
        return [
            ...
            'link'          => $link,
            'matter'        => '你在词条《'.$entry->title.'》的协作计划<'.$cooperation->title.'>中发表的留言信息<'.$parentMessage->title.'>已被回复：<'.$this->entryCooperationMessage->title.'>。'
        ];
    }
