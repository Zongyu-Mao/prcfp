...
class EntryResortSupportAcceptedToUserNotification extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            ...
            'link'          => $link,
            'matter'        => '你在词条《'.$entry->title.'》求助内容<'.$parentResort->title.'>发布的帮助内容：<'.$this->entryResort->title.'>已被采纳接受。'
        ];
    }
