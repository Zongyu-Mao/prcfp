...
class FriendPrivateLetterRepliedNotification extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        $link = '/personal/private-letter#privateLetter'.$l->id;
        return [
            'creator_id'    => $l->from_id,
            'creator'       => $l->from_username,
            'link'          => $link,
            'matter'        => $l->from_username.'回复了你的好友私信：<'.$l->title.'>。'
        ];
    }
