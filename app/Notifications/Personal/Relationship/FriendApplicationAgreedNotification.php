...
class FriendApplicationAgreedNotification extends Notification
{
    use Queueable;
    ...
    {
        $r = $this->userFriendApplicationRecord;
        $user_id = $r->user_id;
        $username = $r->username;
        $link = '/personal/'.$r->user_id;
        return [
            'creator_id'    => $user_id,
            'creator'       => $username,
            'link'          => $link,
            'matter'        => $username.'同意了你的好友申请，现在你们已经成为好友。'
        ];
    }
