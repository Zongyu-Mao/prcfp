...
class ExamResortSupportAcceptedToUserNotification extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            ...
            'link'          => $link,
            'matter'        => '你在试卷《'.$exam->title.'》求助内容<'.$parentResort->title.'>发布的帮助内容：<'.$this->examResort->title.'>已被采纳接受。'
        ];
    }
    /**
