...
class ExamDebateAClosingStatementCreatedNotification extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            ...
            'link'          => $link,
            'matter'        => '对方['.$debate->Aauthor.']已经在攻辩：<'.$debate->title.'>发表攻方的总结陈词。你可以在'.$time.'前回复。[来自试卷：《'.$exam->title.'》]。'
        ];
    }
