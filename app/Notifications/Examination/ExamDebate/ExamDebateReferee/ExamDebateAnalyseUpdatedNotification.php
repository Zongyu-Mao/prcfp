...
namespace App\Notifications\Examination\ExamDebate\ExamDebateReferee;
...
class ExamDebateAnalyseUpdatedNotification extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            ...
            'link'          => $link,
            'matter'        => '裁判方['.$debate->referee.']已经更新<裁判分析>，在你属的攻辩：<'.$debate->title.'>。[来自试卷：《'.$exam->title.'》]。'
        ];
    }
