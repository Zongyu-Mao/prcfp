...
class ExamDebateBFDCreatedToRefereeNotification extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        $article = Exam::find($debate->exam_id);
        ...
        return [
            ...
            'link'          => $link,
            'matter'        => '['.$debate->Bauthor.']已经在你裁判的攻辩：<'.$debate->title.'>发表辩方的自由辩论。[来自试卷：《'.$exam->title.'》]。'
        ];
    }
