...
class ExamOpponentAcceptedNotification extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            'creator_id'    => $this->examOpponent->recipient_id,
            'creator'       => $this->examOpponent->recipient,
            'link'          => $link,
            'matter'        => '你在试卷《'.$exam->title.'》讨论中的[反对]立场内容<'.$this->examOpponent->title.'>已被接受。'
        ];
    }
