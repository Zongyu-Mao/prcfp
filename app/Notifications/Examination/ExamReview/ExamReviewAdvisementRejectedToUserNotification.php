...
class ExamReviewAdvisementRejectedToUserNotification extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            ...
            'link'          => $link,
            'matter'        => '你在试卷《'.$exam->title.'》的评审计划<'.$examReview->title.'>中的建议<'.$parentadvise->title.'>已被拒绝，理由：<'.$advise->title.'>。'
        ];
    }
