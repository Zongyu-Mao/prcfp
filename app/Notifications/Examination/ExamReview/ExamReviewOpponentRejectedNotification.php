...
class ExamReviewOpponentRejectedNotification extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            ...
            'link'          => $link,
            'matter'        => '协作试卷《'.$exam->title.'》的评审计划<'.$examReview->title.'>中的反对意见<'.$parentOpponent->title.'>已被拒绝，理由：<'.$opponent->title.'>。'
        ];
    }
