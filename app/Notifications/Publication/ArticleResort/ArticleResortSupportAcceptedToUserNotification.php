...
class ArticleResortSupportAcceptedToUserNotification extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            ...
            'link'          => $link,
            'matter'        => '你在著作《'.$article->title.'》求助内容<'.$parentResort->title.'>发布的帮助内容：<'.$this->articleResort->title.'>已被采纳接受。'
        ];
    }
