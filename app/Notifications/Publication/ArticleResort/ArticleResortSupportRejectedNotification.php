...
class ArticleResortSupportRejectedNotification extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            ...
            'link'          => $link,
            'matter'        => '你在著作《'.$article->title.'》的求助内容<'.$parentResort->title.'>发布的帮助：<'.$this->articleResort->title.'>已被拒绝。'
        ];
    }
