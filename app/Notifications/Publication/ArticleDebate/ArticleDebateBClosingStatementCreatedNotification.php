...
class ArticleDebateBClosingStatementCreatedNotification extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            ...
            'link'          => $link,
            'matter'        => '对方['.$debate->Bauthor.']已经在你发起的攻辩：<'.$debate->title.'>发表辩方的总结陈词，攻辩选手流程结束。[来自著作：《'.$article->title.'》]。'
        ];
    }
