...
class ArticleDebateBCSCreateToRefereedNotification extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            ...
            'link'          => $link,
            'matter'        => '['.$debate->Bauthor.']已经在你裁判的攻辩：<'.$debate->title.'>发表辩方的总结陈词。现在你可以在'.$debate->deadline.'之前对该攻辩进行裁判总结并结算攻辩。[来自著作：《'.$article->title.'》]。'
        ];
    }
