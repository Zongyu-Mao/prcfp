...
class ArticleDebateBOpeningCreatedNotification extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            ...
            'link'          => $link,
            'matter'        => '对方['.$debate->Bauthor.']已经发表辩方开篇陈词，回应你发起的攻辩<'.$debate->title.'>。你可以在'.$time.'前回复。[来自著作：《'.$article->title.'》]。'
        ];
    }
