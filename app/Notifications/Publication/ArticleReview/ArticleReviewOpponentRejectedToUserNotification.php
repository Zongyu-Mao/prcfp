...
class ArticleReviewOpponentRejectedToUserNotification extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        $parentOpponent = ArticleReviewOpponent::find($this->articleReviewOpponent->pid);
        ...
        return [
            ...
            'link'          => $link,
            'matter'        => '你在著作《'.$article->title.'》评审计划<'.$articleReview->title.'>中的反对意见<'.$parentOpponent->title.'>已被拒绝，理由：<'.$this->articleReviewOpponent->title.'>。'
        ];
    }
