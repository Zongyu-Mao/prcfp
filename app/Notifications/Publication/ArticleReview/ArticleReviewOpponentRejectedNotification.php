...
class ArticleReviewOpponentRejectedNotification extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            ...
            'link'          => $link,
            'matter'        => '协作著作《'.$article->title.'》的评审计划<'.$articleReview->title.'>中的反对意见<'.$parentOpponent->title.'>已被拒绝，理由：<'.$this->articleReviewOpponent->title.'>。'
        ];
    }
