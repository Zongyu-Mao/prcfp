...
class ArticleReviewOpponentAcceptedToUserNotification extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            'creator_id'    => $this->articleReviewOpponent->recipient_id,
            'creator'       => $this->articleReviewOpponent->recipient,
            'link'          => $link,
            'matter'        => '你在著作《'.$article->title.'》的评审计划<'.$articleReview->title.'>中提出的反对意见<'.$this->articleReviewOpponent->title.'>已被接受。'
        ];
    }
