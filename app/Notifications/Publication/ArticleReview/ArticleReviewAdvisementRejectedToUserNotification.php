...
class ArticleReviewAdvisementRejectedToUserNotification extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            ...
            'link'          => $link,
            'matter'        => '你在著作《'.$article->title.'》的评审计划<'.$articleReview->title.'>中的建议<'.$parentAdvise->title.'>已被拒绝，理由：<'.$this->articleReviewAdvise->title.'>。'
        ];
    }
