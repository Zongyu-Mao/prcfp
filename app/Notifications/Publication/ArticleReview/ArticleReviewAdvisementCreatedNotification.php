...
class ArticleReviewAdvisementCreatedNotification extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            ...
            'link'          => $link,
            'matter'        => '协作著作《'.$article->title.'》的评审计划<'.$articleReview->title.'>新增建议<'.$this->articleReviewAdvise->title.'>。'
        ];
    }
