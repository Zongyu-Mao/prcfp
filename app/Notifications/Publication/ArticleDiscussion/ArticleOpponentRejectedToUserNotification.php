...
class ArticleOpponentRejectedToUserNotification extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            ...
            'link'          => $link,
            'matter'        => '你在著作《'.$article->title.'》讨论中的[反对]立场内容<'.$pOpponent.'>已被拒绝。理由：<'.$this->articleOpponent->title.'>。'
        ];
    }
