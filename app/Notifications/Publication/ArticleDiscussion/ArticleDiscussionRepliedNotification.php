...
class ArticleDiscussionRepliedNotification extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        $parentDiscussion = ArticleDiscussion::find($this->articleDiscussion->pid);
        ...
        return [
            ...
            'link'          => $link,
            'matter'        => '你在著作《'.$article->title.'》的[普通]讨论内容<'.$parentDiscussion->title.'>已被回复，内容：<'.$this->articleDiscussion->title.'>。'
        ];
    }
    /**
