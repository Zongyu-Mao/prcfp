...
class EntryMarked extends Notification
{
    use Queueable;
     ...
     * @return void
     */
    public function __construct(SurveillanceMark $surveillanceMark)
    {
        $this->surveillanceMark = $surveillanceMark;
    }
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            ...
            'link'          => $link,
            'matter'        => '你协作的百科内容《'.$content->title.'》已被标记。'
        ];
    }
