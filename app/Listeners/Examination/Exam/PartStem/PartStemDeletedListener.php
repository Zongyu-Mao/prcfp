...
class PartStemDeletedListener
{
     ...
     * Handle the event.
     *
     * @param  PartStemDeletedEvent  $event
     * @return void
     */
    public function handle(PartStemDeletedEvent $event)
    {
        //材料删除后，添加到用户动态，写入协作计划事件，写入试卷动态
        ...
        // 添加事件到著作动态
        $examBehavior = '原试卷材料（'.$stem->sort.'）已经删除：';
