...
class ExamQuestionStemModifiedListener
{
    /**
     ...
     * Handle the event.
     *
     * @param  ExamQuestionStemModifiedEvent  $event
     * @return void
     */
    public function handle(ExamQuestionStemModifiedEvent $event)
    {
        //题干修改后，添加到用户动态，写入协作计划事件，写入试卷动态
        ...
        // 添加事件到用户动态
        $behavior = '编辑了试卷第（'.$question->sort.'）题的题干';
        ...
        // 添加事件到著作动态
        $examBehavior = '试卷第（'.$question->sort.'）题的题干已经重新编辑：';
