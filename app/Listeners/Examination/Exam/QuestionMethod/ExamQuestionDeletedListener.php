...
class ExamQuestionDeletedListener
{
    /**
     ...
     * Handle the event.
     *
     * @param  ExamQuestionDeletedEvent  $event
     * @return void
     */
    public function handle(ExamQuestionDeletedEvent $event)
    {
        //试题删除后，添加到用户动态，写入协作计划事件，写入试卷动态
        ...
        // 添加事件到用户动态
        $behavior = '删除了试卷第（'.$question->sort.'）题';
        ...
        // 添加事件到著作动态
        $examBehavior = '试卷第（'.$question->sort.'）题已经删除：';
