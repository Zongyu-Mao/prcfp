...
class ExamQuestionAnnotationModifiedListener
{
    /**
     ...
     * Handle the event.
     *
     * @param  ExamQuestionAnnotationModifiedEvent  $event
     * @return void
     */
    public function handle(ExamQuestionAnnotationModifiedEvent $event)
    {
        ...
        // 添加事件到用户动态
        $behavior = '编辑了试卷第（'.$question->sort.'）题注释';
        ...
        // 添加事件到著作动态
        $ExamBehavior = '试卷第（'.$question->sort.'）题注释已经重新编辑：';
