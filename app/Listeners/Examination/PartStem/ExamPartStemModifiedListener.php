...
class ExamPartStemModifiedListener
{
    /**
     ...
     * Handle the event.
     *
     * @param  ExamPartStemModifiedEvent  $event
     * @return void
     */
    public function handle(ExamPartStemModifiedEvent $event)
    {
        //材料修改后，添加到用户动态，写入协作计划事件，写入试卷动态
        ...
        // 添加事件到著作动态
        $examBehavior = '试卷材料（'.$stem->sort.'）已经重新编辑：';
