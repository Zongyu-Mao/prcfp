...
class CrateArticleDebateCommentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('article_debate_comments',function(Blueprint $table){
            $table->increments('id');
            $table->integer('aid');
    ...
    {
        Schema::dropIfExists('article_debate_comments');
    }
}
