...
class CreateArticleCooperationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('article_cooperations', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->tinyInteger('secret');  //是否私密创作0非1是
    ...
    {
        Schema::dropIfExists('article_cooperations');
    }
}
