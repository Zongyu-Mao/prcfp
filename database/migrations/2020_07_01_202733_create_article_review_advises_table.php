...
class CreateArticleReviewAdvisesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('article_review_advises', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('rid'); //评审id
            ...
            $table->tinyInteger('round') -> default(1);//轮次，默认第一轮，不能超过三轮
    ...
    {
        Schema::dropIfExists('article_review_advises');
    }
}
