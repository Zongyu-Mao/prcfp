...
class CreateExamCooperationVotesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('exam_cooperation_votes', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('cooperation_id');//试卷协作计划id
    ...
    {
        Schema::dropIfExists('exam_cooperation_votes');
    }
}
