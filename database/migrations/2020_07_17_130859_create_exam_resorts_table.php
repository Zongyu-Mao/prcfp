...
class CreateExamResortsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('exam_resorts', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('cid'); 
            $table->integer('exam_id'); //关联试卷id
    ...
    {
        Schema::dropIfExists('exam_resorts');
    }
}
