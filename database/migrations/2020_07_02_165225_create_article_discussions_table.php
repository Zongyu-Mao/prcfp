...
class CreateArticleDiscussionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('article_discussions', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('article_discussions');
    }
}
