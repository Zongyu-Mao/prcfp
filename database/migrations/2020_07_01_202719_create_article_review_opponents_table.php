...
class CreateArticleReviewOpponentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('article_review_opponents', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('article_review_opponents');
    }
}
