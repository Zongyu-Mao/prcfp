...
class CreateEntryCooperationVotesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('entry_cooperation_votes', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('cooperation_id');//词条协作计划id
    ...
    {
        Schema::dropIfExists('entry_cooperation_votes');
    }
}
