...
class CreateEntryReviewAdvisesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('entry_review_advises', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('entry_review_advises');
    }
}
