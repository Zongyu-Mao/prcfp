...
class CreateSurveillanceRecordsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('surveillance_records', function (Blueprint $table) {
            $table->id();//基本巡查记录表，巡查只以主内容创建和升级为牵涉，其他内容附属主内容，不做牵涉
    ...
    {
        Schema::dropIfExists('surveillance_records');
    }
}
