...
class CreateSurveillanceArticleMarksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('surveillance_article_marks', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('surveillance_article_marks');
    }
}
