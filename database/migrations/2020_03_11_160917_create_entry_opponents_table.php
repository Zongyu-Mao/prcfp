...
class CreateEntryOpponentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('entry_opponents', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('eid'); //词条评审id
    ...
    {
        Schema::dropIfExists('entry_opponents');
    }
}
