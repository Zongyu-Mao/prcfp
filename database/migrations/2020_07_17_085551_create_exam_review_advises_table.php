...
class CreateExamReviewAdvisesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('exam_review_advises', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('rid'); //词条id
    ...
    {
        Schema::dropIfExists('exam_review_advises');
    }
}
