...
class CreateEntryReviewOpponentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('entry_review_opponents', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->tinyInteger('round') -> default(1);//轮次，默认第一轮，不能超过三轮，这里是否需要？？？
    ...
    {
        Schema::dropIfExists('entry_review_opponents');
    }
}
