...
class CreateSurveillanceExamRecordsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('surveillance_exam_records', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('surveillance_exam_records');
    }
}
